...
#define Z_SIGMA_AUTOLEVEL
	...
	#define X_SIGMA_SECOND_PROBE_OFFSET_FROM_EXTRUDER	-13.4 // -14 (LH, 10/01/2018)
	#define Y_SIGMA_SECOND_PROBE_OFFSET_FROM_EXTRUDER	22.2 // 43 (LH, 10/01/2018)
	#define Z_SIGMA_SECOND_PROBE_OFFSET_FROM_EXTRUDER	2.8 // 2.9 (LH, 10/01/2018)
