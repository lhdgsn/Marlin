...
#define VERSION_STRING  "01-1.2.4 Rapidia PP"
...
#define MAX_REDUNDANT_TEMP_SENSOR_DIFF 10 // (EB 19/9/2017)

// Actual temperature must be close to target for this long before M109 returns success
#define TEMP_RESIDENCY_TIME 1  // (seconds)
#define TEMP_HYSTERESIS 500       // (degC) range of +/- temperatures considered "close" to the target one
...
#define HEATER_0_MINTEMP 5 // (EB 19/9/2017)
#define HEATER_1_MINTEMP 5 // (EB 19/9/2017)
#define HEATER_2_MINTEMP 5 // (EB 19/9/2017)
#define BED_MINTEMP 5 // (EB 19/9/2017)

//To clean the extruder's the best temperature configuration
#define	PLA_INSERT_TEMP			 215 // (EB 19/9/2017)
#define	PLA_REMOVE_TEMP			 170 // (EB 19/9/2017)
#define	PLA_PRINT_TEMP			 215 // (EB 19/9/2017)
#define PLA_BED_TEMP			 65 // (EB 19/9/2017)
...
#define EXTRUDER_LEFT_CLEAN_TEMP 170 // (EB 19/9/2017)
...
#define EXTRUDE_MINTEMP 150 // (EB 19/9/2017) //With DUAL X it only counts extruder0 temp
...
//32+222+28=282
	...
	#define X_MIN_POS 0 // 0 (EB, 21/6/2017)
	#define Y_MAX_POS 285 //295 (EB, 16/6/2017)
	#define Y_MIN_POS 0 // 0 (EB 19/6/2017)
...
// Preheat Constants
#define PLA_PREHEAT_HOTEND_TEMP  215 // (EB 19/9/2017)
#define PLA_PREHEAT_HPB_TEMP 45 // (EB 19/9/2017)
...
#define Z_SIGMA_AUTOLEVEL
...
#ifdef Z_SIGMA_HOME
	#if BCN3D_PRINTER == BCN3D_SIGMA_PRINTER
		#define Z_SIGMA_HOME_X_POINT 30// (EB, 22/6/2017) 58
	#endif
	#if BCN3D_PRINTER == BCN3D_SIGMAX_PRINTER
	...
	#define Y_SIGMA_SECOND_PROBE_OFFSET_FROM_EXTRUDER	43 // 24 (LH 16/10/2017)
	#define Z_SIGMA_SECOND_PROBE_OFFSET_FROM_EXTRUDER	2.7 // 2.80//2.90 (LH 16/10/2017)
	#if BCN3D_PRINTER == BCN3D_SIGMA_PRINTER
		...
		#define Y_SIGMA_PROBE_2_LEFT_EXTR 26 //(EB, 23/6/2017) 15
		...
		#define X_SIGMA_PROBE_3_RIGHT_EXTR 80 //(EB, 20/6/2017) 55
	...
	//Calibration WIZARD --------
	// Adjustment screw locations (cargol = screw)
	#define PAS_M5 0.85 // screw pitch
...
#if BCN3D_PRINTER == BCN3D_SIGMA_PRINTER
	#define NOZZLE_PARK_DISTANCE_BED_X0	10 // (EB 22/6/2017) 47
	#define NOZZLE_PARK_DISTANCE_BED_Y0	-2.5
	#define PRINTER_BED_X_SIZE	256.0 // LH (10/11/2017)
#endif
#if BCN3D_PRINTER == BCN3D_SIGMAX_PRINTER
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,96.43}  // default steps per unit for Ultimaker
		...
		#define DEFAULT_AXIS_STEPS_PER_UNIT {80,80,1600,9000}	  //1/16 microstepping for BCN3D Board (EB 19/9/2017), original on next line
