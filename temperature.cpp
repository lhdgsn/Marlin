...
static void updateTemperaturesFromRawValues()
{
    ...
    {
        current_temperature[e] = 210 ; // analog2temp(current_temperature_raw[e], e); (EB 19/9/2017)
    }
    current_temperature_bed = 65; // analog2tempBed(current_temperature_bed_raw); (EB 19/9/2017)
    // #ifdef TEMP_SENSOR_1_AS_REDUNDANT (EB 19/9/2017)
